...
DEMO_PROPS: Dict[str, Dict[str, Any]] = {
    ...
    "BrowserDecisionTable": {"title": "ТАБЛИЦА ВЫБОРА", "url": "provider.example/compare", "columns": ["Модель", "Цена", "Качество"], "rows": [{"name": "A", "Модель": "A", "Цена": "низкая", "Качество": "88"}, {"name": "B", "Модель": "B", "Цена": "средняя", "Качество": "92"}], "selectedCell": {"row": 2, "column": 3}, "caption": "Выделяем решение, а не весь экран."},
